        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-3 lg:gap-x-8">
          ...
          <div className="relative p-8 bg-white border border-border rounded-2xl shadow-sm flex flex-col">
            <div className="flex-1">
              ...
              <p className="mt-6 text-muted-foreground">Ideal para começar a organizar suas primeiras células.</p>
              ...
              <ul className="mt-6 space-y-4">
                ...
                <li className="flex opacity-50">
                  <XCircleIcon /> <span className="ml-3 text-muted-foreground decoration-muted-foreground line-through">IA Insights</span>
                </li>
              </ul>
            </div>
          ...
          <div className="relative p-8 bg-white border-2 border-blue-600 rounded-2xl shadow-xl flex flex-col transform scale-105 z-10">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-semibold text-foreground">{PLANS.PRO.name}</h3>
              <p className="mt-4 flex items-baseline text-foreground">
                <span className="text-5xl font-extrabold tracking-tight">R$49</span>
                <span className="ml-1 text-xl font-semibold text-muted-foreground">,90/mês</span>
              </p>
              <p className="mt-6 text-muted-foreground">Para igrejas em crescimento que precisam de dados inteligentes.</p>
          ...
          <div className="relative p-8 bg-white border border-border rounded-2xl shadow-sm flex flex-col">
            <div className="flex-1">
              ...
              <p className="mt-6 text-muted-foreground">Gestão completa para grandes ministérios e múltiplas redes.</p>
...
// Helper Icon
const XCircleIcon = () => (
  <svg className="flex-shrink-0 w-6 h-6 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor">
