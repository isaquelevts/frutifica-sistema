                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="w-full min-w-0">
                    ...
                    <input
                      type="date"
                      {...register('date')}
                      className={`block w-full px-4 py-2 rounded-lg bg-white border ${errors.date ? 'border-red-500' : 'border-slate-300'} text-slate-800 font-medium focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none`}
                    />
